...
df.drop(columns=['UserID','Video ID'], inplace=True)
...
if df_selection.empty:
    ...
    # KPIs
    st.markdown("<u><h2 style='text-align: center'>📌 Key Performance Indicators</h2></u>", unsafe_allow_html=True)
    ...
    with pie_col1:
        ...
        fig_prof1 = px.pie(df_selection, values='Satisfaction ', names='Profession', title="Profession Breakdown")
    ...
    with pie_col2:
        ...
        fig_demo1 = px.pie(df_selection, values='Satisfaction', names='Demographics', title="Demographics Breakdown")
    ...
    with pie_col3:
        ...
        fig_freq1 = px.pie(df_selection, values='Satisfaction', names='Frequency', title="Usage Frequency")
