...
# Fill user-selected + dummy values
user_features = [
    age,
    gender_map[gender],
...
# Add 14 dummy feature values (use dataset mean or 0 as placeholder)
# Ensure consistent feature ordering with the training dataset
dummy_values = [0] * (19 - len(user_features))  # or replace with known mean values
full_features = np.array(user_features + dummy_values).reshape(1, -1)
